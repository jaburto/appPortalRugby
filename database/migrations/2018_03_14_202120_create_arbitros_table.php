...
class CreateArbitrosTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Arbitros", 'arbitros', 'desapellidopaterno', 'fa-list', [
            ["desnombre", "Nombre", "String", false, "", 0, 256, true],
            ["desapellidopaterno", "Apellido Paterno", "String", false, "", 0, 256, true],
            ["desapellidomaterno", "Apellido Materno", "String", false, "", 0, 256, true],
            ["fecnacimiento", "Fecha de nacimiento", "Date", false, "", 0, 0, false],
