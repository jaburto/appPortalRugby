...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $catalogo->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Catalogos", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/catalogos/'.$catalogo->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Catalogos", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.catalogos.destroy', $catalogo->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/catalogos') }}" data-toggle="tooltip" data-placement="right" title="Back to Catalogos"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'desetiqueta')
						@la_display($module, 'desdetalle')
					</div>
				</div>
			</div>
		</div>
