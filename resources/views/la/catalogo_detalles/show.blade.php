...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $catalogo_detalle->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Catalogo_Detalles", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/catalogo_detalles/'.$catalogo_detalle->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Catalogo_Detalles", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.catalogo_detalles.destroy', $catalogo_detalle->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/catalogo_detalles') }}" data-toggle="tooltip" data-placement="right" title="Back to Catalogo Detalles"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'id_app_catalogo')
						@la_display($module, 'desvalor')
						@la_display($module, 'numvalor')
						@la_display($module, 'numorden')
					</div>
				</div>
			</div>
		</div>
