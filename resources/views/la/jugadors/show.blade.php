...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $jugador->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Jugadors", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/jugadors/'.$jugador->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Jugadors", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.jugadors.destroy', $jugador->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/jugadors') }}" data-toggle="tooltip" data-placement="right" title="Back to Jugadors"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'desapellidopaterno')
						@la_display($module, 'desapellidomaterno')
						@la_display($module, 'desalias')
						@la_display($module, 'imgfoto')
						@la_display($module, 'valposicion')
						@la_display($module, 'desheight')
						@la_display($module, 'desweight')
						@la_display($module, 'fecnacimiento')
